...
while(1)
{
 ...
 //adc_msg[] = "xxxx\n\r\n\0";
 adc_msg[0]= digits[(int)(ADCRead_value /1000)%10];
 adc_msg[1]= digits[(int)(ADCRead_value /100)%10];
 adc_msg[2]= digits[(int)(ADCRead_value /10)%10];
 adc_msg[3]= digits[(int)(ADCRead_value /1)%10];
